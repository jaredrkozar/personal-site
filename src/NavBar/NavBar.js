...
import { ReactComponent as JKIcon } from  "../Images/JKIcon.svg";
...
function NavBar() {
  return (
    <nav className="bg-inherit text-inherit flex justify-center items-center h-20">
        <div className=" w-full flex flex-wrap bg-transparent justify-between px-6">
        
            <div class="flex items-center relative gap-3">
                <div class="text-2xl font-bold gap-4 flex rounded-md relative bg-transparent">
                   <JKIcon/>
                   <h1>Jared Kozar</h1>
                </div>
                </div>
