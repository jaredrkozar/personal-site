...
export const appList = {
    "simplenotes": {
        name: "SimpleNotes",
        language: 'Swift',
        shortDescription: 'Easily take notes with your iPhone or iPad, using a pen, hghlighter, text and more.',
        ...
        <br/>,
        "You can import PDFs and notes from Google Drive, Dropbox, FIles, by scanning a document, and by drag and drop.",
        <br/>,
        ...
        technologies: ["Core Graphics", "Core Data", "Networking", "Programmatic UI", "Mac Catalyst", "Diffable Data Sources"],
    ...
    "visiontext": {
        name: "VisionText",
        language: 'Swift',
        shortDescription: 'Read text aloud from any image or document.',
        ...
        technologies: ["VisionKit", "Core Data", "AVFoundation", "Programmatic UI", "Mac Catalyst"],
        link: "www.google.com",
    ...
    "imageresizer": {
        name: "imageResizer",
        language: 'Swift',
        shortDescription: 'Easily resize any image on your iPad or Mac.',
        ...
        technologies: ["Core Data", "Core Graphics", "Programmatic UI", "Mac Catalyst"],
    ...
    "calculator": {
        name: "Calculator",
        language: 'Swift',
        shortDescription: 'A simple, yet customizable calculator for iPhone and Apple Watch.',
        ...
        technologies: ["Storyboards", "Apple Watch"],
        githubLink: "www.google.com",
