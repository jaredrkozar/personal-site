...
function IOSApps() {
    const colors = {
        ...
        opaqueBackground: "bg-orange-300/40 dark:bg-orange-600/30",
        ...
        fullText: "text-orange-600 dark:text-orange-200 font-bold"
    }
    ...
    return (
        <div className="">
            <HeaderTextStyle title="iOS Apps" bgStyle={colors.fullBackground}>
                <h1 className="md:text-3xl text-2xl font-medium text-black dark:text-white">Here are some of the iOS, iPadOS, Mac, and Apple Watch apps I've worked on using <span className={colors.fullText}>Swift and SwiftUI</span>:</h1>
            </HeaderTextStyle>
