...
export function Card(props) {
    let classstr = "content-center relative p-4 h-fit w-fit mr-5 sm:mr-0 w-[30rem]" + props.backgroundColor + " rounded-lg flex flex-col dark:text-white text-black";
        ...
        <div className={classstr}>
            <div className="flex flex-row align-baseline relative space-x-24">
                ...
                <div className="flex flex-col relative text-left space-y-2">
                    <h1 className="md:text-4xl text-3xl font-bold">{props.currentApp.name}</h1>
