...
export function Card(props) {
    ...
    return (
        <div className={classstr}>
            ...
            <img class="pb-2 pt-2 w-100 object-scale-down relative rounded-md block dark:hidden" src={props.currentApp.lightScreenshots} alt="app screenshot"></img>
            <img class="pb-2 pt-2 h-80 w-100 object-scale-down relative rounded-md hidden dark:block" src={props.currentApp.darkScreenshots} alt="app screenshot"></img>
